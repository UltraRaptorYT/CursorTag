/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/wrangler.jsonc cloudflare/worker-configuration.d.ts` (hash: 4abd08f527a8a0eb7bb400a3803a89fe)
// Runtime types generated with workerd@1.20260811.1 2026-08-17 nodejs_compat
interface __BaseEnv_Env {
	MAX_PLAYERS: "16";
	ROOMS: DurableObjectNamespace<import("./worker").GameRoom>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MAX_PLAYERS">> {}
}
